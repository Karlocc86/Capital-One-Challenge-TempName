...
1. nessie_client.py + scripts/seed.py (1 customer, 2 accounts [Checking + Savings], 8 merchants, 26 purchases, 2 deposits, 4 bills — dataset fijo en app/demo_data.py)
