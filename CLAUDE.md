...
1. nessie_client.py + scripts/seed.py (1 customer, 2 accounts [Checking + Savings], 9 merchants, 35 purchases, 2 deposits, 9 bills — dataset fijo en app/demo_data.py)
